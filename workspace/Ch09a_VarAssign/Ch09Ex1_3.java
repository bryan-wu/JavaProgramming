/**
 * Chapter 9 - Variables and Assignment Statements Programming Exercises 1-3
 * 
 * @author Bryan Wu
 * @version 10/2/14
 * @author Period - 7
...
public class Ch09Ex1_3
{
     ...
     * assigns a value to it, and writes statement that computes a value for the
     * quadratic and stores the result in another double precision variable.
    ...
    /**
     * Testing method: instantiates a Ch09Ex1_3 object and then invokes each
     * method
     * 
     * @param args
