...
public class Ch19Ex1to4
{
    ...
    {
        System.out.println( "Enter the beginning balance: " ); // Have the
                                                               // program prompt
                                                               // for the
                                                               // beginning
                                                               // balance,
        double balance = scan.nextDouble();
        System.out.println( "Enter the monthly interest: " ); // the monthly
                                                              // interest, and
                                                              // the payment
                                                              // amount. Also,
                                                              // when the
        double monthlyInterestRaw = scan.nextDouble();
        double monthlyInterest = monthlyInterestRaw * .01;
        System.out.println( "Enter the monthly payment: " );
        double monthlyPayment = scan.nextDouble(); // balance falls below the
                                                   // amount of the monthly
                                                   // payment, write out the
                                                   // final payment that will
        ...
        System.out.println( "Final Payment to bring balance to exactly zero: $"
            + ( totalPayments - Math.abs( balance ) ) );
    ...
    public void drugPotency()
    {
        ...
        while ( effectiveness > 50.0 ) // keep effectiveness above 50
        {
    ...
    public void newtons1overX()
    {
        ...
        if ( b < 0 )
        {
            guess = -0.00001; // check if + b
        }

        while ( Math.abs( guess - old ) > 0.0000001 )
        {

            old = guess;

            guess = guess * ( 2 - guess * b );
        }
        double quotient = a * guess;
