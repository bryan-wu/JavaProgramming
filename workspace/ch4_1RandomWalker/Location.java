 ...
 *
 * <p>
 * The <code>Location</code> class is copyright&copy; 2002 College Entrance
 * Examination Board (www.collegeboard.com).
 *
 * @author Alyce Brady
...
public class Location implements Comparable
{
     ...
     * @return <code>true</code> if <code>other</code> is at the same row and
     *         column as the current location; <code>false</code> otherwise
     **/
    ...
    /**
     * Generates a hash code for this location (will not be tested on the
     ...
     * than, equal to, or greater than <code>other</code>. Locations 
     * are ordered
     * in row-major order. (Precondition: <code>other</code> is a
     ...
     * 
     * @return a string indicating the row and column of the location in (row,
     *         col) format
     **/
