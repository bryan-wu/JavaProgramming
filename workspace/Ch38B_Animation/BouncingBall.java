 ...
 */
// *code has been modified by Bryan Wu*
public class BouncingBall extends Circle
{
    ...
    public void doFrame( Graphics g, int width, int height )
    {
        ...
        if ( getX() - getRadius() < 0 )
        {
            setColor( new Color( rand.nextInt( 256 ),
                rand.nextInt( 256 ),
                rand.nextInt( 256 ) ) );
     ...
     * of the ball, the velocity of the ball does not change.) This method uses
     * some standard vector mathematics.
     */
