...
/*
    The class SimpleAnimationApplet2 provides a generic framework for applets
    ...
    To use this framework, define a subclass of SimpleAnimationApplet2 and
    ...
    This applet is compatible with Java version 1.2 or later.  It has the
    same functionality as an older program SimpleAnimationApplet.java,
    which was written in Java 1.0 and works with any version of Java.
...
public class SimpleAnimationApplet2 extends JApplet implements ActionListener
{
