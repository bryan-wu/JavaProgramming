...
{
    /*
     * This class displays the dice. The dice are rolled by calling this class's
     * roll() method.
     */
    ...
    {
        /*
         * Constructor. To initialize the canvas, set a light blue background
         * color.
         */
        ...
        try
        {
            completeURL = new URL( new URL( "file:"
                + System.getProperty( "user.dir" ) + "/" ), "click.au" );
        }
    ...
    /*
     * Draw a die with upper left corner at (x,y). The die is 35 by 35 pixels in
    ...
    /*
     * Roll the dice by randomizing their values. Tell the system to repaint the
     * panel, to show the new values. Also, play a clicking sound to give the
     * user more feedback.
     */
    private void roll()
    {
