 ...
 * 
 * Assignment: Lesson 54 - PhoneBook (ArrayList) Period: 1 - 7
 * 
...
public class PhoneBookTester
{
    ...
    public static void doSearch( PhoneBook pb )
    {
        ...
        ArrayList<PhoneEntry> pEntry = pb.search( new PhoneEntry( firstName,
            lastName,
            "" ) );
